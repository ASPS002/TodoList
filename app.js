...
mongoose.connect("mongodb+srv://ujjwal:<password>@cluster0.k4le7pi.mongodb.net/todolistDB")//it will connect to local host having port 27017 and then search for sample_airbnb db and if it will not find one it will create one
